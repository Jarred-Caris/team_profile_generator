          ...
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">Name:Placeholder</li>
                  <li class="list-group-item">Email:Placeholder@email.com</li>
                  <li class="list-group-item">Github:placeholder</li>
                </ul>
          ...
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">Name:Placeholder</li>
                  <li class="list-group-item">Email:Placeholder@email.com</li>
                  <li class="list-group-item">Office Number: 1234</li>
                </ul>
          ...
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">Name:Placeholder</li>
                  <li class="list-group-item">Email:Placeholder@email.com</li>
                  <li class="list-group-item">School:placeholder</li>
                </ul>
